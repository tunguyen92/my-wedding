...
const Header = () => {
  ...
  return (
    <header
      className={`sticky shadow-lg top-0 left-0 w-full z-50 text-white transition-all`}
    >
        ...
        <div className="flex justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center md:order-2">
              <a
                href="#send-wishes"
                className="text-white bg-primary hover:opacity-80 transition-opacity focus:ring-4 focus:ring-primary font-medium rounded-lg text-sm px-4 md:px-5 py-2 md:py-2.5 mr-2"
                onClick={(e) => handleScroll(e, "send-wishes")}
              >
                Gửi lời chúc
              </a>
